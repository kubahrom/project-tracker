...
const IssuesList = ({ loading, issues, filterBy, sortBy, resetFilter }: IIssuesListProps) => {
        ...
        <div>
            {loading ? (
                ...
                <Grid container className={classes.issuesWrapper}>
                    ...
                    {(filteredIssues.length === 0 && (issues.length !== 0)) && <NoneIssue isFilter={true} resetFilter={resetFilter}/>}
